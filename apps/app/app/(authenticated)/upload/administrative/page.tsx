...
const recentContracts: Contract[] = [
  {
    id: "1",
    fileName: "employee_policy_manual.pdf",
    fileType: "pdf",
    size: 3_200_000,
    status: "complete",
    progress: 100,
    contractType: "Policy Manual",
    riskScore: 45,
    uploadedAt: new Date(Date.now() - 5_400_000),
  },
  {
    id: "2",
    ...
    riskScore: 62,
    uploadedAt: new Date(Date.now() - 10_800_000),
  },
];
            ...
            prev.map((upload) =>
              upload.id === id
                ? {
                    ...upload,
                    status: "complete",
                    contractType: "Administrative Document",
    ...
    <div className="flex h-full flex-col gap-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Upload administrative contracts, policies, and internal documents for
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-muted-foreground text-sm">
              ...
              <li>• HR Documents</li>
              <li>• Facility Management Agreements</li>
            </ul>
          </div>
        </div>
