...
const recentContracts: Contract[] = [
  {
    id: "1",
    fileName: "vendor_master_service_agreement.pdf",
    fileType: "pdf",
    size: 3_800_000,
    status: "complete",
    progress: 100,
    contractType: "MSA",
    riskScore: 65,
    uploadedAt: new Date(Date.now() - 5_800_000),
  },
  {
    id: "2",
    ...
    riskScore: 48,
    uploadedAt: new Date(Date.now() - 12_000_000),
  },
];
...
const BusinessPage = () => {
            ...
            prev.map((upload) =>
              upload.id === id
                ? {
                    ...upload,
                    status: "complete",
                    contractType: "Business Contract",
  ...
  return (
    <div className="flex h-full flex-col gap-6 p-6">
      <div>
        <h1 className="mb-2 font-semibold text-3xl">Business Contracts</h1>
        <p className="text-muted-foreground">
          Upload commercial agreements, vendor contracts, and business documents
          for AI-powered risk analysis
        </p>
      </div>
      ...
      <div className="grid flex-1 gap-6 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Card className="border-[#1e1e2e] bg-[#111118] p-4">
            <h3 className="mb-3 font-semibold">Recent Business Uploads</h3>
